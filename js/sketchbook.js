...
/*global $, window, confirm, addEvent*/

document.getElementById("recent-sketches").innerHTML = "";
window.sketchbookHistory.getList(document.getElementById("recent-sketches"));
if (window.sketchbookHistory.count()) {
    document.getElementById("sketchbook-album").style.display = "block";
} else {
    document.getElementById("sketchbook-album").style.display = "none";
}
