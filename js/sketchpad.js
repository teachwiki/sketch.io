...
// @license magnet:?xt=urn:btih:0b31508aeb0634b347b8270c7bee4d411b5d4109&dn=agpl-3.0.txt AGPL-3 https://www.gnu.org/licenses/agpl-3.0-standalone.html
/**
 * @source: http://developers.sketchpad.pro/dist/src/NSSketchpad-commercial.js
 *
 * Sketchpad.pro
 * {@link http://sketchpad.pro|Sketchpad.pro - drawing board sketch free}
 *
...
/*global ICONFIG*/ //integration config
...
var NSSketchpad = {
    avaliableTools: [],
    defaultTool: "smoothpen",
    postPdfUrl: (window.ICONFIG && (ICONFIG.postPdfUrl)) || "https://uploader.imagehost.pro:3443/upload",
    postImageUrl: (window.ICONFIG && (ICONFIG.postImageUrl)) || "https://uploader.imagehost.pro:3443/upload",
    postWebshotUrl: (window.ICONFIG && (ICONFIG.postWebshotUrl)) || "https://uploader.imagehost.pro:3443/webshot?site=",
    proxyExcludedDomain: (window.ICONFIG && (ICONFIG.proxyExcludedDomain)) || "imagehost.pro",
    proxyImageUrl: (window.ICONFIG && (ICONFIG.proxyImageUrl)) || "https://imagehost.pro/proxy",
    //please keep Appropriate Legal Notices
    watermarkTitle: (window.ICONFIG && (ICONFIG.watermarkTitle)) || "This is commercial version of sketchpad.pro.\nVisit http://developers.sketchpad.pro for open-source version.\nThis program is distributed in the hope that it will be useful, but WITHOUT ANY WARRANTY.",
    watermarkImageSrc: "images/branding-logo.svg"
};
